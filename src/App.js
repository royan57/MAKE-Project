        ...
        <table className = "titleBar">
          <tbody>
            ...
            <tr className = "titleBar">
               <input className = "searchBar" onChange={this.searchChangeHandler.bind(this)} placeholder = "Enter movie title..." onEmptied = "Enter movie title..." /> 
            </tr>
            {this.state.rows}
            <tr>
            <img className = "obamaImage" src = "Obama Final.png"/>
            </tr>
          </tbody>
        </table>
      </div>
